...
We treat this SDP problem as a relaxation of the primal problem. After obtaining the solution for the SDP, we search across the values of the elemnents of z to minimize the original cost function.
...
\begin{center}$
\begin{array}{cc}
\includegraphics[width=0.45\linewidth]{fig/roc_before} &
\includegraphics[width=0.45\linewidth]{fig/roc_after} \\
\end{array}$
\end{center}
\caption{Precision and recall of ene-to-end word detection and recognition methods on the SVT dataset. F-score are shown in brackets. Notice that the proposed character detector captures more precise and reliable characters and lead to better result on full image.}
